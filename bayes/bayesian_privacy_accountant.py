...
from bayes.scaled_renyi import scaled_renyi_gaussian
...
class BayesianPrivacyAccountant:
    ...
    def get_privacy(self, target_eps=None, target_delta=None):
        ...
        if target_eps is None:
            return np.min(
                (self.privacy_cost - np.log(target_delta - (1 - np.exp(self.logconf)))) / self.powers), target_delta
        else:
    ...
    @staticmethod
    def _log_binom_expect(n, p, scaled_renyi_fn, ldistr, rdistr):
        """
