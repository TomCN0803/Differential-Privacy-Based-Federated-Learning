...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        for idx in idxs_users:
            ...
            w, loss, curLR = local.train(student=copy.deepcopy(net_glob).to(args.device))
        ...
        print("Round {:3d},Testing accuracy: {:.2f}".format(epoch, acc_t))
